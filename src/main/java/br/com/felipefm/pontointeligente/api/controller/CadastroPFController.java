...
import br.com.felipefm.pontointeligente.api.dtos.CadastroPFDto;
...
import br.com.felipefm.pontointeligente.api.services.EmpresaService;
...
private static Logger log = LoggerFactory.getLogger(CadastroPFController.class);
	...
	private void validarDadosExistentes(CadastroPFDto cadastroPFDto, BindingResult result) {
		...
		this.funcionarioService.buscarPorEmail(cadastroPFDto.getEmail()).ifPresent(func -> result.addError(new ObjectError("funcionario", "E-mail já existente.")));
	}
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhoDiaOpt().ifPresent(qtdHorasTrabDias -> cadastroPFDto.setQtdHorasTrabalhoDia(Optional.of(Float.toString(qtdHorasTrabDias))));
